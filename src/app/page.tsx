            ...
            <div className="mt-4 border border-slate-600  rounded-lg  border-b-transparent border-r-transparent min-h-screen">
              ...
              <div>
                ...
                <div className="flex m-4 gap-4">
                  <div className="grid grid-rows-4 grid-cols-2 w-3/5 gap-4">
                    <>
                      <div className="border border-slate-600 rounded-lg px-2 py-5 bg-[#141414]">
                    ...
                    <div className="row-span-2 col-span-2 border border-slate-600 rounded-lg px-2 py-5 bg-[#141414]">
                  ...
                  <div className="grid grid-rows-4 w-2/5 gap-4">
                    <div className="row-span-2 border border-green-600 bg-green-950 p-2 rounded-lg">
                      ...
                      <div className="flex justify-start w-1/2 ml-10 gap-10 my-5">
                        <div>
                ...
                <div className="w-auto m-4 border border-slate-600 rounded-lg px-2 py-5 bg-[#141414]">
                  <h2 className="text-indigo-300 inline-flex ">
                    <AccountBalanceWalletIcon className="text-indigo-300 mx-1" />
                    Overall Trades
                    <p className="text-white text-l ml-3 text-semibold">1022</p>
                  </h2>
                  <div className="flex justify-between">
